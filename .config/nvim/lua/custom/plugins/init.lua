    ...
    config = function()
      require('themery').setup {
        ...
        themes = {
          ...
          { name = 'Everforest', colorscheme = 'everforest', before = [[ vim.g.everforest_background = nil ]] },
          { name = 'Everforest Dark Hard', colorscheme = 'everforest', before = [[ vim.g.everforest_background = 'hard' ]] },
          { name = 'Everforest Dark Medium', colorscheme = 'everforest', before = [[ vim.g.everforest_background = 'medium' ]] },
          { name = 'Everforest Dark Soft', colorscheme = 'everforest', before = [[ vim.g.everforest_background = 'soft' ]] },
          { name = 'Everforest Light', colorscheme = 'everforest', before = [[ vim.o.background = 'light' ]] },
          { name = 'Everforest Light Hard', colorscheme = 'everforest', before = [[ vim.o.background = 'light'; vim.g.everforest_background = 'hard' ]] },
          { name = 'Everforest Light Medium', colorscheme = 'everforest', before = [[ vim.o.background = 'light'; vim.g.everforest_background = 'medium' ]] },
          { name = 'Everforest Light Soft', colorscheme = 'everforest', before = [[ vim.o.background = 'light'; vim.g.everforest_background = 'soft' ]] },
          ...
          { name = 'Material', colorscheme = 'material', before = [[ vim.g.material_style = nil ]] },
          ...
          { name = 'Material (Lighter)', colorscheme = 'material', before = [[ vim.g.material_style = 'lighter'; vim.o.background = 'light' ]] },
          ...
          { name = 'Moonfly', colorscheme = 'moonfly', before = [[ vim.g.moonflyItalics = false; vim.g.moonflyTransparent = false; package.loaded['moonfly'] = nil ]] },
          { name = 'Moonfly (Transparent)', colorscheme = 'moonfly', before = [[ vim.g.moonflyItalics = false; vim.g.moonflyTransparent = true; package.loaded['moonfly'] = nil ]] },
          ...
          { name = 'Sonokai', colorscheme = 'sonokai', before = [[ vim.g.sonokai_style = nil ]] },
